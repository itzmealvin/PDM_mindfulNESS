...
public class frmExplorer extends JFrame {
    ...
    private frmExplorer() {
        ...
        goBackToLoginButton.addActionListener(e -> {
            int option = JOptionPane.showConfirmDialog(null, "Are you sure you want to return to login page?", "Confirmation", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
            ...
            SwingWorker<Void, Void> worker = new SwingWorker<>() {
                ...
                protected Void doInBackground() {
                    ...
                    if (resultTable.getColumnCount() == 0 || resultTable.getRowCount() == 0) {
                        JOptionPane.showMessageDialog(null, "No result found, check your query again!", "Warning", JOptionPane.WARNING_MESSAGE);
                    }
                    return null;
                }
