...
public class frmBooking extends JFrame {
    ...
    public frmBooking() {
        ...
        refreshButton.addActionListener(e -> {
            ...
            SwingWorker<Void, Void> worker = new SwingWorker<>() {
                ...
                protected Void doInBackground() {
                    ...
                    JOptionPane.showMessageDialog(null, "Refreshed available healing successfully!", "Success!", JOptionPane.INFORMATION_MESSAGE);
                    return null;
                }
        ...
        submitHealingButton.addActionListener(e -> {
            if (idField.getText().isEmpty()) {
                JOptionPane.showMessageDialog(null, "Healing ID field is empty", "Warning", JOptionPane.WARNING_MESSAGE);
                return;
            }
            int option = JOptionPane.showConfirmDialog(null, "Confirm healing with ID: " + idField.getText() + " ?", "Confirmation", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
            if (option == JOptionPane.YES_OPTION) {
