    ...
    private frmIndex() {
        ...
        logInButton.addActionListener(e -> {
            ...
            if (accField.getText().isEmpty() || String.valueOf(pwdField.getPassword()).isEmpty()) {
                JOptionPane.showMessageDialog(null, "Either account or password is empty!", "Warning", JOptionPane.WARNING_MESSAGE);
            ...
            SwingWorker<Void, Void> worker = new SwingWorker<>() {
                ...
                protected Void doInBackground() {
                    ...
                    if (Objects.equals(results[1], "Patient")) {
                        ...
                        JOptionPane.showMessageDialog(null, "Either account not exists or credentials not correct!", "Warning", JOptionPane.WARNING_MESSAGE);
                        pwdField.setText("");
                    }
                    return null;
                }
        ...
        explorerModeButton.addActionListener(e -> {
            ...
            SwingWorker<Void, Void> worker = new SwingWorker<>() {
                @Override
                protected Void doInBackground() {
                    String masterPassword = JOptionPane.showInputDialog(null, "Enter the master password to continue: ", "Master Password Required", JOptionPane.INFORMATION_MESSAGE);
                    if (Objects.equals(masterPassword, "mindfulness")) {
                        frmExplorer.getInstance().setVisible(true);
                        setVisible(false);
                    } else {
                        JOptionPane.showMessageDialog(null, "Master Password not correct!", "Access Denied", JOptionPane.WARNING_MESSAGE);
                    }
                    return null;
                }
