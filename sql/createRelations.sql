...
(
    ...
    [IndentityNumber] [varchar]
(
    50
) NOT NULL,
    [GraduationUniversity] [varchar]
(
    50
) NOT NULL,
    FOREIGN KEY
...
(
    PatientID
) REFERENCES [Account].[Patient]
(
    Patient_ID
),
    FOREIGN KEY
(
    HealingInformationID
) REFERENCES [Booking].[HealingInformation]
(
    HealingInformation_ID
))
    GO
